...
import ParticlesComponent from "../assets/particles"; // Asegúrate de tener la ruta correcta a tu componente de partículas

function Home() {
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-3xl w-full">
        <ParticlesComponent id="particles-background" /> {/* Aquí se renderizan las partículas como fondo */}
